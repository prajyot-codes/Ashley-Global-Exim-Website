  ...
  const products = [
    {
      ...
      description: "Ruby-red premium pomegranates with exceptional sweetness and juiciness. Perfect arils with deep crimson color and outstanding shelf life.",
      size: "8-12 cm diameter",
      weight: "250-400g per fruit",
      packaging: "5kg/10kg corrugated boxes with protective foam padding",
    ...
    },
    {
      ...
      grade: "Grade A",
      image: "https://images.unsplash.com/photo-1553158073-4a7b999a2e30?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      description: "High-quality pomegranates specially selected for international export. Excellent taste profile with optimal sugar content and minimal waste.",
    ...
    },
    {
      ...
      description: "Certified organic pomegranates grown without pesticides or chemicals. Natural farming methods ensure pure, healthy fruit with authentic taste.",
    ...
    },
    {
      ...
      packaging: "Individual wrapping in 3kg/5kg premium gift boxes",
